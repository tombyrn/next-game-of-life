...
export const GridContext = createContext({cellGrid: initGrid(DEFAULT_ROWS, DEFAULT_COLS), setCellGrid: {} as Dispatch<SetStateAction<number[][]>>, rows: DEFAULT_ROWS, setRows: {} as Dispatch<SetStateAction<number>>, cols: DEFAULT_COLS, setCols: {} as Dispatch<SetStateAction<number>>});
...
export default function GridProvider({children}: {children: React.ReactNode}) {
    ...
    return (
        <GridContext.Provider value={{cellGrid, setCellGrid, rows, setRows, cols, setCols}}>
            {children}
